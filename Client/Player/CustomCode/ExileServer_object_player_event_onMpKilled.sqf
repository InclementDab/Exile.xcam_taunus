...
switch (_killType) do 
{
	default 
	{
		...
		[
			...
			"%1 died cold and alone.",
			"%1 died. Yes, %1 is dead. Like really dead-dead.",
			"%1 GOT P. FUCKING. DIDDLED.",
			"%1 ate shit, got pissed, and may have jumped off a bridge",
			"%1 jumped off a building... and didnt do a backflip...",
			"%1 is now on suicide watch",
			"%1 wishes he grabbed that bloodbag 37 minutes ago",
			"%1 forgot to pay his rent",
			"%1 did not duck."
		];
		_countDeath = true;
