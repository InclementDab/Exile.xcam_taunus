...
Author: Quiksilver (contact: armacombatgroup@gmail.com)
...
_QS_ST_showMOS_range = 100;									// NUMBER. Range in distance to show MOS on the map. Default 3500.
...
_QS_ST_GPSDist = 1000;											// NUMBER. Distance from player that units shown on GPS. Higher number = lower script performance. Not significant but every 1/10th of a frame counts! Default 300
