...
force ace_advanced_ballistics_simulationInterval = 0.097742;
...
force ace_medical_delayUnconCaptive = 1;
...
// ACE Name Tags
ace_nametags_defaultNametagColor = [0.77,0.51,0.08,0];
...
force ace_pylons_timePerPylon = 4.96138;
...
force ace_viewdistance_viewDistanceOnFoot = 7;
